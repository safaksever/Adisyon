...
import com.example.safak.adisyon.listele.Listele10;
...
public class Masa10 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_masa10);

        list = new ArrayList<>();
        liste = new ArrayList<>();
        listi = new ArrayList<>();
        listYemek = (ExpandableListView) findViewById(R.id.listYemek10);
        listDrink = (ListView) findViewById(R.id.listDrink10);
        listTatli = (ListView) findViewById(R.id.listTatli10);
        ...
        listYemek.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                ...
                SharedPreferences preferences = getSharedPreferences("urun10", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                Gson gson = new Gson();
                String jsonurun = gson.toJson(listi);
                editor.putString("liste10", jsonurun);
                editor.apply();
    ...
    public void list(View view) {
        startActivity(new Intent(this, Listele10.class));
    }
}
