...
public class Listele4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listele4);

        final SharedPreferences sharedPreferences = getSharedPreferences("urun4", Context.MODE_PRIVATE);
        String jsonurun = sharedPreferences.getString("liste4", "");
        Gson gson = new Gson();
        ...
        listView = (ListView) findViewById(R.id.liste4);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Listele4.this);
