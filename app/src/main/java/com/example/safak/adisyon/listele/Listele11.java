...
public class Listele11 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listele11);

        final SharedPreferences sharedPreferences = getSharedPreferences("urun11", Context.MODE_PRIVATE);
        String jsonurun = sharedPreferences.getString("liste11", "");
        Gson gson = new Gson();
        ...
        listView = (ListView) findViewById(R.id.liste11);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Listele11.this);
