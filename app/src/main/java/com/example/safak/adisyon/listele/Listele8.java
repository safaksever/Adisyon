...
public class Listele8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listele8);

        final SharedPreferences sharedPreferences = getSharedPreferences("urun8", Context.MODE_PRIVATE);
        String jsonurun = sharedPreferences.getString("liste8", "");
        Gson gson = new Gson();
        ...
        listView = (ListView) findViewById(R.id.liste8);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Listele8.this);
