...
public class Listele3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listele3);

        final SharedPreferences sharedPreferences = getSharedPreferences("urun3", Context.MODE_PRIVATE);
        String jsonurun = sharedPreferences.getString("liste3", "");
        Gson gson = new Gson();
        ...
        listView = (ListView) findViewById(R.id.liste3);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Listele3.this);
