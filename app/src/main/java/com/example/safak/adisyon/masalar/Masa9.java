...
import com.example.safak.adisyon.listele.Listele9;
...
public class Masa9 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_masa9);

        list = new ArrayList<>();
        liste = new ArrayList<>();
        listi = new ArrayList<>();
        listYemek = (ExpandableListView) findViewById(R.id.listYemek9);
        listDrink = (ListView) findViewById(R.id.listDrink9);
        listTatli = (ListView) findViewById(R.id.listTatli9);
        ...
        listYemek.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                ...
                SharedPreferences preferences = getSharedPreferences("urun9", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                Gson gson = new Gson();
                String jsonurun = gson.toJson(listi);
                editor.putString("liste9", jsonurun);
                editor.apply();
    ...
    public void list(View view) {
        startActivity(new Intent(this, Listele9.class));
    }
}
