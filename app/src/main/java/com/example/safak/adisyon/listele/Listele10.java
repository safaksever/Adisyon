...
public class Listele10 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listele10);

        final SharedPreferences sharedPreferences = getSharedPreferences("urun10", Context.MODE_PRIVATE);
        String jsonurun = sharedPreferences.getString("liste10", "");
        Gson gson = new Gson();
        ...
        listView = (ListView) findViewById(R.id.liste10);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Listele10.this);
