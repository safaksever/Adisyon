...
import com.example.safak.adisyon.listele.Listele11;
...
public class Masa11 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_masa11);

        list = new ArrayList<>();
        liste = new ArrayList<>();
        listi = new ArrayList<>();
        listYemek = (ExpandableListView) findViewById(R.id.listYemek11);
        listDrink = (ListView) findViewById(R.id.listDrink11);
        listTatli = (ListView) findViewById(R.id.listTatli11);
        ...
        listYemek.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                ...
                SharedPreferences preferences = getSharedPreferences("urun11", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                Gson gson = new Gson();
                String jsonurun = gson.toJson(listi);
                editor.putString("liste11", jsonurun);
                editor.apply();
    ...
    public void list(View view) {
        startActivity(new Intent(this, Listele11.class));
    }
}
