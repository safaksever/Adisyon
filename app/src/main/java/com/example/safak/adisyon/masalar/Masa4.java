...
import com.example.safak.adisyon.listele.Listele4;
...
public class Masa4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_masa4);

        list = new ArrayList<>();
        liste = new ArrayList<>();
        listi = new ArrayList<>();
        listYemek = (ExpandableListView) findViewById(R.id.listYemek4);
        listDrink = (ListView) findViewById(R.id.listDrink4);
        listTatli = (ListView) findViewById(R.id.listTatli4);
        ...
        listYemek.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                ...
                SharedPreferences preferences = getSharedPreferences("urun4", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                Gson gson = new Gson();
                String jsonurun = gson.toJson(listi);
                editor.putString("liste4", jsonurun);
                editor.apply();
    ...
    public void list(View view) {
        startActivity(new Intent(this, Listele4.class));
    }
}
