...
import com.example.safak.adisyon.listele.Listele7;
...
public class Masa7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_masa7);

        list = new ArrayList<>();
        liste = new ArrayList<>();
        listi = new ArrayList<>();
        listYemek = (ExpandableListView) findViewById(R.id.listYemek7);
        listDrink = (ListView) findViewById(R.id.listDrink7);
        listTatli = (ListView) findViewById(R.id.listTatli7);
        ...
        listYemek.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                ...
                SharedPreferences preferences = getSharedPreferences("urun7", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                Gson gson = new Gson();
                String jsonurun = gson.toJson(listi);
                editor.putString("liste7", jsonurun);
                editor.apply();
    ...
    public void list(View view) {
        startActivity(new Intent(this, Listele7.class));
    }
}
