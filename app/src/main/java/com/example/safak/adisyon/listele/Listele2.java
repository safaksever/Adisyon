...
public class Listele2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listele2);

        final SharedPreferences sharedPreferences = getSharedPreferences("urun2", Context.MODE_PRIVATE);
        String jsonurun = sharedPreferences.getString("liste2", "");
        Gson gson = new Gson();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Listele2.this);
