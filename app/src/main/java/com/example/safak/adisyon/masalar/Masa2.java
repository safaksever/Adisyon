...
import com.example.safak.adisyon.listele.Listele2;
...
public class Masa2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        liste = new ArrayList<>();
        listi = new ArrayList<>();
        listYemek = (ExpandableListView) findViewById(R.id.listYemek2);
        listDrink = (ListView) findViewById(R.id.listDrink2);
        listTatli = (ListView) findViewById(R.id.listTatli2);
        ...
        listYemek.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                ...
                SharedPreferences preferences = getSharedPreferences("urun2", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = preferences.edit();
                Gson gson = new Gson();
                String jsonurun = gson.toJson(listi);
                editor.putString("liste2", jsonurun);
                editor.apply();
    ...
    public void list(View view){startActivity(new Intent(this,Listele2.class));}
    }
