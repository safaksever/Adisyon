...
public class Listele12 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listele12);

        final SharedPreferences sharedPreferences = getSharedPreferences("urun12", Context.MODE_PRIVATE);
        String jsonurun = sharedPreferences.getString("liste12", "");
        Gson gson = new Gson();
        ...
        listView = (ListView) findViewById(R.id.liste12);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Listele12.this);
