...
public class Listele9 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listele9);

        final SharedPreferences sharedPreferences = getSharedPreferences("urun9", Context.MODE_PRIVATE);
        String jsonurun = sharedPreferences.getString("liste9", "");
        Gson gson = new Gson();
        ...
        listView = (ListView) findViewById(R.id.liste9);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Listele9.this);
