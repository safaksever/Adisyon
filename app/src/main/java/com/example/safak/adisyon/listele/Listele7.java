...
public class Listele7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listele7);

        final SharedPreferences sharedPreferences = getSharedPreferences("urun7", Context.MODE_PRIVATE);
        String jsonurun = sharedPreferences.getString("liste7", "");
        Gson gson = new Gson();
        ...
        listView = (ListView) findViewById(R.id.liste7);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Listele7.this);
